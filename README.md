...
2. Запустите файл `run.bat`.
   - Скрипт автоматически создаст `.env` файл с начальными параметрами окружения, установит зависимости, поднимет контейнеры и запустит приложение.

## Инструкция по развертыванию вручную
